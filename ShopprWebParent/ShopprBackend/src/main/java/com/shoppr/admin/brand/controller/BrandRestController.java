...
import com.shoppr.admin.brand.BrandNotFoundRestException;
import com.shoppr.admin.brand.BrandService;
import com.shoppr.admin.brand.CategoryDTO;
...
public class BrandRestController {
	...
	List<CategoryDTO> listCategoriesByBrand(@PathVariable(name = "id") Integer brandId) throws BrandNotFoundRestException {
